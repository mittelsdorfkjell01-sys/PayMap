...
CREATE TABLE "City" (
    ...
    "slug" TEXT NOT NULL,
    "flag" TEXT NOT NULL,
    "isHomeCity" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "TaxRegime" (
    ...
    "cityId" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "incomeRate" DOUBLE PRECISION NOT NULL,
    "socialRate" DOUBLE PRECISION NOT NULL,
    "exemptFrac" DOUBLE PRECISION,
...
-- CreateTable
CREATE TABLE "TaxRegimeTranslation" (
    "id" TEXT NOT NULL,
    "regimeId" TEXT NOT NULL,
    "locale" TEXT NOT NULL,
    "label" TEXT NOT NULL,

    CONSTRAINT "TaxRegimeTranslation_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "CityDetail" (
    ...
    CONSTRAINT "CityDetail_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "HomeTaxConfig" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "HomeTaxConfig_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CostOfLiving_cityId_key" ON "CostOfLiving"("cityId");

-- CreateIndex
CREATE UNIQUE INDEX "TaxRegimeTranslation_regimeId_locale_key" ON "TaxRegimeTranslation"("regimeId", "locale");

-- CreateIndex
CREATE UNIQUE INDEX "CityDetail_cityId_section_locale_key" ON "CityDetail"("cityId", "section", "locale");

-- CreateIndex
CREATE UNIQUE INDEX "HomeTaxConfig_countrySlug_key" ON "HomeTaxConfig"("countrySlug");
...
-- CreateIndex
CREATE INDEX "CostOfLivingItem_cityId_category_periodStart_idx" ON "CostOfLivingItem"("cityId", "category", "periodStart");

-- CreateIndex
CREATE UNIQUE INDEX "CityWeather_cityId_key" ON "CityWeather"("cityId");

-- CreateIndex
CREATE UNIQUE INDEX "CountryProfile_countryId_locale_key" ON "CountryProfile"("countryId", "locale");
...
-- CreateIndex
CREATE INDEX "CitySearch_fromCityId_createdAt_idx" ON "CitySearch"("fromCityId", "createdAt");

-- CreateIndex
CREATE INDEX "CitySearch_toCityId_createdAt_idx" ON "CitySearch"("toCityId", "createdAt");

-- CreateIndex
CREATE INDEX "CitySearch_fromCityId_toCityId_idx" ON "CitySearch"("fromCityId", "toCityId");

-- CreateIndex
CREATE INDEX "CitySearchAggregate_toCityId_searchCount_idx" ON "CitySearchAggregate"("toCityId", "searchCount");

-- CreateIndex
CREATE UNIQUE INDEX "CitySearchAggregate_fromCityId_toCityId_period_key" ON "CitySearchAggregate"("fromCityId", "toCityId", "period");

-- CreateIndex
CREATE UNIQUE INDEX "WatchlistItem_userId_cityId_key" ON "WatchlistItem"("userId", "cityId");

-- CreateIndex
CREATE UNIQUE INDEX "MovingPlan_userId_fromCityId_toCityId_key" ON "MovingPlan"("userId", "fromCityId", "toCityId");

-- CreateIndex
CREATE UNIQUE INDEX "OneShot_stripePaymentId_key" ON "OneShot"("stripePaymentId");
...
-- AddForeignKey
ALTER TABLE "CostOfLiving" ADD CONSTRAINT "CostOfLiving_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaxRegime" ADD CONSTRAINT "TaxRegime_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TaxRegimeTranslation" ADD CONSTRAINT "TaxRegimeTranslation_regimeId_fkey" FOREIGN KEY ("regimeId") REFERENCES "TaxRegime"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CityDetail" ADD CONSTRAINT "CityDetail_cityId_fkey" FOREIGN KEY ("cityId") REFERENCES "City"("id") ON DELETE CASCADE ON UPDATE CASCADE;
